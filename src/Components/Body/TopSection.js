...
const TopSection = ({ mainHeader, subHeader, isButton }) => {
  return (
    <div className='relative flex flex-col justify-center items-center text-[#0028F2] p-4 h-fit w-full '>
      <h1 className="mt-48 mb-10 text-center text-2xl font-extrabold leading-none tracking-tight  md:text-4xl lg:text-4xl ">{mainHeader}</h1>
      <p className="mb-32 text-center text-lg font-normal p-4 lg:text-xl  ">{subHeader} </p>
